...
Open your preferred database management tool (e.g., Beekeeper Studio or pgAdmin 4).

Connect to your PostgreSQL instance.

Open the answers.sql file.

Run the script. Note: Ensure you run the file in order from top to bottom to maintain the structural hierarchy (Table Creation → Data Insertion → Queries).